...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps
            .Where(e => e.DeptNo == 30) //z dzialu 30
            .Min(e => e.Sal);           //min pensja
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps
            .OrderBy(e => e.HireDate)   //sortujemy po dacie zatrudnienia
            .Take(2)        //bierzemy pierwsze 2 os
            .ToList();
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps
            .Where(e => e.Mgr != null)  //mgr nie null
            .ToList();
